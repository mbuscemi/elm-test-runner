...
export default {
    ...
    activateSubscriptions() {
        ...
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'elm-test-runner:toggle-auto-run': () => {
                this.elmTestRunnerView.toggleAutoRun();
                this.elm.ports.toggleAutoRun.send(null);
            }
        }));

        this.subscriptions.add(atom.commands.add('atom-workspace', {
            'elm-test-runner:toggle-auto-navigate': () => {
                this.elmTestRunnerView.toggleAutoNavigate();
                this.elm.ports.toggleAutoNavigate.send(null);
            }
        }));
