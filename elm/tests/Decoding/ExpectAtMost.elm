module Decoding.ExpectAtMost exposing (parsesCorrectly)
...
parsesCorrectly =
    ...
    describe "parsesCorrectly" <|
        ...
        , test "has correct message" <|
            \_ ->
                Expect.equal (Failure.getMessage failure) "Expect.atMost"
        , test "has no given" <|
            \_ ->
...
failingJsonString =
    """{"event":"testCompleted","status":"fail","labels":["FailureOutputValidation","Expect.atMost","basic case","failing on greater"],"failures":[{"given":null,"message":"Expect.atMost","reason":{"type":"custom","data":{"first":"2","second":"3","comparison":"Expect.atMost"}}}],"duration":"2"}"""
