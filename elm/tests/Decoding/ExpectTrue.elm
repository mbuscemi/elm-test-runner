module Decoding.ExpectTrue exposing (parsesCorrectly)
...
parsesCorrectly =
    ...
    describe "parsesCorrectly" <|
        ...
        , test "has correct message" <|
            \_ ->
                Expect.equal (Failure.getMessage failure) "Expect.true"
        , test "has no given" <|
            \_ ->
...
failingJsonString =
    """{"event":"testCompleted","status":"fail","labels":["FailureOutputValidation","Expect.true","basic case","failing"],"failures":[{"given":null,"message":"Expect.true","reason":{"type":"custom","data":"this should fail / true for false"}}],"duration":"0"}"""
