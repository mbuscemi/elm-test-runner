module Decoding.ExpectNotWithin exposing (parsesCorrectly)
...
parsesCorrectly =
    ...
    describe "parsesCorrectly" <|
        ...
        , test "has correct message" <|
            \_ ->
                Expect.equal (Failure.getMessage failure) "Expect.notWithin Absolute 0.01"
        , test "has no given" <|
            \_ ->
...
failingJsonString =
    """{"event":"testCompleted","status":"fail","labels":["FailureOutputValidation","Expect.notWithin","pi","failing"],"failures":[{"given":null,"message":"Expect.notWithin Absolute 0.01","reason":{"type":"custom","data":{"first":"3.141592653589793","second":"3.14","comparison":"Expect.notWithin Absolute 0.01"}}}],"duration":"2"}"""
