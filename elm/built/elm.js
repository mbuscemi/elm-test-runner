...
var _user$project$State_Failure$getExpected = function (failure) {
	...
	if (_p6._0.ctor === 'Just') {
		if (_p6._1.ctor === 'Just') {
			return _user$project$State_Failure$expectationText(_p6._0._0);
		} else {
			return _user$project$State_Failure$expectationText(_p6._0._0);
		}
	} else {
...
var _user$project$State_Failure$ListFields = function (a) {
	return {ctor: 'ListFields', _0: a};
};
var _user$project$State_Failure$expectation = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_lang$core$Json_Decode$map,
			_user$project$State_Failure$ListFields,
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$core$Json_Decode$map, _user$project$State_Failure$Simple, _elm_lang$core$Json_Decode$string),
			_1: {ctor: '[]'}
		}
	});
		...
		_1: {
			...
			_0: A2(
				...
				A6(
					...
					_elm_lang$core$Json_Decode$maybe(
						A2(_elm_lang$core$Json_Decode$field, 'actual', _user$project$State_Failure$expectation)),
					_elm_lang$core$Json_Decode$maybe(
						A2(_elm_lang$core$Json_Decode$field, 'expected', _user$project$State_Failure$expectation)),
					_elm_lang$core$Json_Decode$maybe(
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {projectName: a, compilerError: b, runStatus: c, totalTests: d, passedTests: e, runDuration: f, runSeed: g, testRuns: h, testHierarchy: i, testMouseIsOver: j, selectedTest: k, selectedTestFailure: l, autoRunEnabled: m, randomSeed: n, forceRandomSeedEnabled: o};
														};
													};
												};
											};
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {runStatus: a, compilerError: b, totalTests: c, passedTests: d, runDuration: e, runSeed: f, testHierarchy: g, nodeMouseIsOver: h, selectedNode: i, selectedNodeFailure: j, autoRunEnabled: k, randomSeed: l, forceRandomSeedEnabled: m};
												};
											};
										};
									};
