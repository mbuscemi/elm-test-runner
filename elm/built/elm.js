...
var _user$project$Tree_Merge$findSubNode = F2(
...
var _user$project$Tree_Merge$excludeSubNode = F2(
	function (field, subNodes) {
		return A2(
			...
			function (_p8) {
				var _p9 = _p8;
				return !_elm_lang$core$Native_Utils.eq(_p9._0, field);
			},
			subNodes);
	});
var _user$project$Tree_Merge$fromPath = F2(
	function (list, tree) {
		fromPath:
		while (true) {
			var _p10 = {ctor: '_Tuple2', _0: list, _1: tree};
			if (_p10._0.ctor === '::') {
				if (_p10._1._1.ctor === '[]') {
					var _p13 = _p10._1._0;
					var _p12 = _p10._0._1;
					var _p11 = _p10._0._0;
					if (_elm_lang$core$Native_Utils.eq(_p11, _p13)) {
						var _v6 = _p12,
							_v7 = A2(
							_user$project$Tree_Tree$Node,
							_p11,
					...
					if (_p10._0._1.ctor === '::') {
						var _p18 = _p10._1._0;
						var _p17 = _p10._1._1;
						var _p16 = _p10._0._1._1;
						var _p15 = _p10._0._1._0;
						var _p14 = _p10._0._0;
						return _elm_lang$core$Native_Utils.eq(_p14, _p18) ? A2(
							_user$project$Tree_Tree$Node,
							_p18,
							A2(
								_elm_lang$core$List$append,
								A2(_user$project$Tree_Merge$excludeSubNode, _p15, _p17),
								{
									ctor: '::',
									_0: A2(
										_user$project$Tree_Merge$fromPath,
										_p16,
										A2(_user$project$Tree_Merge$findSubNode, _p15, _p17)),
									_1: {ctor: '[]'}
								})) : A2(
							_user$project$Tree_Tree$Node,
							_p18,
						...
						return A2(
							...
							A2(
								_elm_lang$core$List$append,
								A2(_user$project$Tree_Merge$excludeSubNode, _p19, _p10._1._1),
								{
									ctor: '::',
									_0: A2(
										_user$project$Tree_Merge$fromPath,
				...
				if (_p10._1._1.ctor === '[]') {
					...
					return A2(_user$project$Tree_Tree$Node, _p10._1._0, _p10._1._1);
				}
			}
		}
	});
